...
// analyze-team-video edge function for bareback.
//
...
const SYSTEM_PROMPT =
  "You are an expert bareback coach reviewing a roster athlete's run for a coaching team. " +
        ...
        messages: [
          { role: "system", content: SYSTEM_PROMPT + " JSON schema: " + JSON.stringify(ANALYSIS_SCHEMA) },
          {
            ...
            content: [
              {
                type: "text",
                text: `Analyze this bareback run${athlete_name ? ` by ${athlete_name}` : ""}.`,
              },
              ...images,
            ],
          },
